...
#define COLOUR_ENUM(COLOUR) \
    ...
    COLOUR(DOVE_GREY,) /* 42% */ \
    COLOUR(BOULDER,) /* 46% */ \
    COLOUR(GRANITE,) /* 50%, actually a duplicate of GREY50 */ \
    COLOUR(OSLO_GREY,) /* 54% */ \
...
/* UI color pairs */
#define CP_UI_BRIGHT_FG  COLOR_PAIR(BLACK_2)
#define CP_UI_FG         COLOR_PAIR(BLUE_2)
#define CP_UI_BORDER     COLOR_PAIR(GREEN_2)
