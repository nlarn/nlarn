monsters = {
    ...
    [MT_DEMONLORD_VII] = {
      ...
      color = LIGHTRED,
      exp = 200000,
      flags = HEAD + NOBEHEAD + HANDS + FLY + INVISIBLE + INFRAVISION + DEMON + RES_POISON + RES_CONF,
      hp_max = 260,
      glyph = "&",
      intelligence = 26,
      level = 18,
    ...
    [MT_DEMON_PRINCE] = {
      ...
      color = RED,
      exp = 300000,
      flags = HEAD + NOBEHEAD + HANDS + FLY + INVISIBLE + INFRAVISION + DEMON + RES_FIRE + RES_SLEEP + RES_POISON + RES_CONF,
      hp_max = 345,
      glyph = "&",
      intelligence = 28,
      level = 25,
    ...
    [MT_SPIRIT_NAGA] = {
      ...
      color = MAGENTA,
      exp = 20000,
      flags = HEAD + NOBEHEAD + FLY + SPIRIT + INFRAVISION + RES_SLEEP + RES_POISON + RES_CONF,
      hp_max = 95,
      glyph = "N",
      intelligence = 23,
      level = 11,
