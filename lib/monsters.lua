monsters = {
    ...
    [MT_DEMONLORD_I] = {
      ...
      color = LIGHTRED,
      exp = 50000,
      flags = HEAD + NOBEHEAD + HANDS + FLY + INVISIBLE + INFRAVISION + DEMON + RES_POISON,
      hp_max = 140,
      glyph = "&",
      intelligence = 20,
      level = 12,
    ...
    [MT_DEMON_PRINCE] = {
      ...
      color = RED,
      exp = 300000,
      flags = HEAD + NOBEHEAD + HANDS + FLY + INVISIBLE + INFRAVISION + DEMON + RES_FIRE + RES_SLEEP + RES_POISON,
      hp_max = 345,
      glyph = "&",
      intelligence = 28,
      level = 25,
    ...
    [MT_GELATINOUSCUBE] = {
      ...
      color = CYAN,
      exp = 45,
      flags = METALLIVORE + RES_SLEEP + RES_POISON,
      hp_max = 22,
      glyph = "g",
      intelligence = 3,
      level = 5,
    ...
    [MT_SPIRIT_NAGA] = {
      ...
      color = MAGENTA,
      exp = 20000,
      flags = HEAD + NOBEHEAD + FLY + SPIRIT + INFRAVISION + RES_SLEEP + RES_POISON,
      hp_max = 95,
      glyph = "N",
      intelligence = 23,
      level = 10,
    ...
    [MT_VAMPIRE] = {
      ...
      color = RED,
      exp = 1000,
      flags = HEAD + HANDS + FLY + UNDEAD + INFRAVISION + REGENERATE + RES_SLEEP + RES_POISON,
      hp_max = 50,
      glyph = "V",
      intelligence = 17,
      level = 7,
