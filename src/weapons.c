...
const weapon_data weapons[WT_MAX] =
{
    ...
    { WT_ODAGGER,       "orcish dagger",             "orc dagger",      WC_MELEE,     AMMO_MAX,  2,   2, IM_IRON,   850,     6, 0, 0, 1, 0, 1 },
    { WT_DAGGER,        "dagger",                    "dagger",          WC_MELEE,     AMMO_MAX,  3,   3, IM_IRON,   600,    10, 0, 0, 1, 1, 1 },
    { WT_SLING,         "sling",                     "sling",          WC_RANGED,   AMMO_SLING,  1,   2, IM_CLOTH,  200,    15, 1, 0, 1, 1, 0 },
    { WT_OSHORTSWORD,   "orcish short sword",        "orc short sword", WC_MELEE,     AMMO_MAX,  5,   1, IM_IRON,  1350,    30, 0, 0, 1, 0, 0 },
    { WT_SHORTSWORD,    "short sword",               "short sword",     WC_MELEE,     AMMO_MAX,  6,   2, IM_IRON,  1000,    60, 0, 0, 1, 1, 0 },
    { WT_ESHORTSWORD,   "elven short sword",         "elf short sword", WC_MELEE,     AMMO_MAX,  7,   2, IM_WOOD,  1180,    68, 0, 0, 1, 0, 0 },
    { WT_OSPEAR,        "orcish spear",              "orc spear",       WC_MELEE,     AMMO_MAX,  8,   2, IM_IRON,  2100,    75, 0, 0, 1, 0, 1 },
    { WT_SPEAR,         "spear",                     "spear",           WC_MELEE,     AMMO_MAX, 10,   2, IM_IRON,  1800,   120, 0, 0, 1, 1, 1 },
    { WT_ESPEAR,        "elven spear",               "elf spear",       WC_MELEE,     AMMO_MAX, 11,   3, IM_WOOD,  1600,   140, 0, 0, 1, 0, 1 },
    { WT_BOW,           "bow",                       "bow",            WC_RANGED,     AMMO_BOW,  3,   3, IM_WOOD,  1000,   220, 1, 0, 1, 1, 0 },
    { WT_MACE,          "mace",                      "mace",            WC_MELEE,     AMMO_MAX, 12,   1, IM_IRON,  2600,   160, 0, 0, 1, 1, 0 },
    { WT_FLAIL,         "flail",                     "flail",           WC_MELEE,     AMMO_MAX, 14,   1, IM_IRON,  2900,   195, 1, 0, 1, 1, 0 },
